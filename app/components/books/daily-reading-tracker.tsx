...
export function DailyReadingTracker({ dailyPagesMap }: DailyReadingTrackerProps) {
  ...
  const getIntensityClass = (pages: number) => {
      ...
      if (pages < 30) return "bg-green-300 dark:bg-green-800/60";
      if (pages < 60) return "bg-green-400 dark:bg-green-700/80";
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1"><div className="w-2 h-2 bg-green-200 dark:bg-green-900/40 rounded-sm"></div> 1-9 pages</span>
                <span className="flex items-center gap-1"><div className="w-2 h-2 bg-green-500 dark:bg-green-600 rounded-sm"></div> 60+ pages</span>
            </div>
        </div>
      </CardHeader>
                        ...
                        <div className="flex flex-wrap gap-1 flex-1">
                            ...
                            return (
                                ...
                                <TooltipTrigger asChild>
                                    <div
                                        className={`w-2.5 h-2.5 rounded-sm transition-all hover:ring-1 hover:ring-ring ${intensityClass} ${
                                            isToday ? "ring-2 ring-red-500 ring-offset-2 ring-offset-background" : ""
                                        }`}
                                    />
                                </TooltipTrigger>
