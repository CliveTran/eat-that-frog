    ...
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {otherTasks.length === 0 && (
            <div className="text-center py-12 border-2 border-dashed rounded-lg border-slate-200 dark:border-slate-800 bg-muted/50 text-slate-500">
          ...
          {otherTasks.map((task) => (
            <div key={task.id} className="flex items-center gap-3 p-3 rounded-lg border bg-card shadow-sm hover:shadow-md transition-shadow">
              <Checkbox
  ...
  if (mode === "schedule") {
    return (
      <div className="space-y-4 pt-4">
        ...
        <ScrollArea className="h-[600px] border rounded-md p-4 bg-muted/50">
